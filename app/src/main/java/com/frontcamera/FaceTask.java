...
public class FaceTask extends AsyncTask{
    ...
    protected Object doInBackground(Object[] params) {
        ...
        try {
            ...
            String currentBase64 = SurfaceViewCallback.bitmapToBase64(rawbitmap);
            SurfaceViewCallback.getInstacne().setmCurrentFrame64(currentBase64);
            SurfaceViewCallback.getInstacne().addFrameToQueue(currentBase64);
